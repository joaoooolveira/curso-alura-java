...
import br.com.alura.PraticandoJAVA.metodos.ConversaoDeTemperatura;
...
public class VariaveisTipos {
    public static void main(String[] args) {
        ...
        ConversaoDeTemperatura converter = new ConversaoDeTemperatura();
        converter.ConverterTemperaturaParaFahrenheit(celsius);
